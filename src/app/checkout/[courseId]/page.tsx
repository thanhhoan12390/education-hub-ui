...
function Checkout() {
    ...
    const { data: course, isLoading } = useSWR<Course>(url, { revalidateOnFocus: false });
            ...
            <div className={cx('checkout-content')}>
                ...
                <main className={cx('checkout-overview')}>
                    ...
                    <section className={cx('order-details')}>
                        <h2 className={cx('order-heading')}>Order details&nbsp; (1 course)</h2>
                ...
                <aside className={cx('checkout-summary')}>
                    <div className={cx('summary-wrapper')}>
                        <div className={cx('order-summary')}>
                            ...
                            <div className={cx('price-group')}>
                                <span className={cx('total-text')}>Total&nbsp;(1 course)</span>
                        ...
                        <div className={cx('marketplace-checkout')}>
                            ...
                            <CheckoutButton
                                ...
                                cart={course?.courseId ? [course?.courseId] : []}
                            />
