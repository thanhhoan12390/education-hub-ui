            ...
            <div className={cx('bot-content')}>
                ...
                <div className={cx('des-content')}>
                    ...
                    <div>
                        ...
                        <p>
                            Universities have been slow at creating specialized data science programs. (not to mention
                            that the ones that exist are very expensive and time consuming)
                        </p>
                        <p>
